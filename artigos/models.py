...
class Artigo(models.Model):
    ...
    intro_texto1 = models.TextField(max_length=200, blank=True, null=True)
    intro_top2 = models.CharField(max_length=200, blank=True, null=True)
    intro_texto2 = models.TextField(max_length=200, blank=True, null=True)
    intro_top3 = models.CharField(max_length=200, blank=True, null=True)
    intro_texto3 = models.TextField(max_length=200, blank=True, null=True)
    intro_top4 = models.CharField(max_length=200, blank=True, null=True)
    intro_texto4 = models.TextField(max_length=200, blank=True, null=True)
    intro_top5 = models.CharField(max_length=200, blank=True, null=True)
    intro_texto5 = models.TextField(max_length=200, blank=True, null=True)
    intro_top6 = models.CharField(max_length=200, blank=True, null=True)
    intro_texto6 = models.TextField(max_length=200, blank=True, null=True)
